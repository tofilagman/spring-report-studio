...
@Component({
  selector: 'app-request-logs-error-info',
  templateUrl: './request-logs-error-info.component.html',
  styleUrls: ['./request-logs-error-info.component.scss']
})
export class RequestLogsErrorInfoComponent implements OnInit, OnDestroy {
