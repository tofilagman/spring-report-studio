...
@Component({
  ...
  templateUrl: './bswitch.component.html',
  styleUrls: ['./bswitch.component.scss']
})
export class BSwitchComponent implements AfterViewInit, ControlValueAccessor, OnChanges {
